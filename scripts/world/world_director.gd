...
const RESOURCE_CATALOG: Array[Dictionary] = [
	{"id": "wood", "name": "Wood", "weight": 22.0, "min": 1, "max": 3, "type": 0},
	{"id": "herb", "name": "Herb", "weight": 17.0, "min": 1, "max": 3, "type": 0},
	{"id": "mushroom", "name": "Mushroom", "weight": 13.0, "min": 1, "max": 2, "type": 0},
	{"id": "stone", "name": "Stone", "weight": 14.0, "min": 1, "max": 4, "type": 0},
	{"id": "fiber", "name": "Fiber", "weight": 11.0, "min": 2, "max": 5, "type": 0},
	...
	match biome:
		"quarry":
			if resource_id in ["stone", "iron_ore", "coal", "gold_ore", "crystal"]:
				weight *= 2.4
		"grove":
			if resource_id in ["wood", "herb", "fiber", "mushroom", "berry", "moon_petal"]:
				weight *= 1.8
		"shore":
			if resource_id in ["stone", "berry", "sunstone"]:
				weight *= 1.7
	return weight
